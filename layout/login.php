...
<body id="<?php p($PAGE->bodyid) ?>" class="cbp-spmenu-push <?php p($PAGE->bodyclasses.' '.join($bodyclasses)) ?>">
    ...
    <div id="wrapper">
        ...
        <header id="page-header" class="clearfix">
            <div class="header-inner dropdown container-fluid-narrow">
                <?php
                    if (!$haslogo) { ?>
                <?php
                } else { ?>
    ...
    <?php } ?>
    <div id="page" class="container-fluid-narrow">
        <div id="page-content" class="row-fluid">
            ...
            <div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-header">
                    ...
                    <h2 id="myModalLabel">Getting Started</h2>
                </div>
            ...
            <!-- Contact Form Modal -->
            <div id="contact-form-modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h2 id="myModalLabel">Your work here?</h2>
                </div>
                <h3 class="thankyou"><i class="icon-ok success"></i>Thankyou, we will be in touch once we are ready to accept submissions.</h3>
                <form name="contactform" id="contactform" action="/" class="form-horizontal">
                    <div class="modal-body">
                        <p>If you would like to display your work on the Learning Space login page</p>
                        <div class="control-group">
                            <label class="control-label" for="first_name">First Name *</label>
                            <div class="controls">  
                                <input type="text" id="form-first-name" name="first_name" maxlength="50" size="30">
                                <i class="icon-ok success"></i>
                                <i class="icon-remove fail"></i><br />
                                <span class="help-block"><small>Please tell us your first name.</small></span>
                            </div>  
                        </div> 
                        ...
                        <div class="control-group">        
                            ...
                            <div class="controls">
                                <input  type="text" id="form-last-name" name="last_name" maxlength="50" size="30">
                                <i class="icon-ok success"></i>
                                <i class="icon-remove fail"></i><br />
                                <span class="help-block"><small>Please tell us your last name.</small></span>
                            </div>
                        </div>       
                        ...
                        <div class="control-group">        
                            ...
                            <div class="controls">
                                <input type="text" id="input-email" name="email" maxlength="80" size="30">
                                <i class="icon-ok success"></i>
                                <i class="icon-remove fail"></i><br />
                                <span class="help-block"><small>Please tell us your email address.</small></span>
                            </div>
                        </div>   
                    ...
                    <div class="modal-footer">
                        <div class="control-group">     
                            <div class="controls">
                                <input id="emailformsubmit" type="submit" class="btn-primary btn">
                                <span id="emailformsubmitplaceholder" class="btn">Submit</span> 
                                <button class="btn" data-dismiss="modal">Close</button>  
                            </div>
                        </div> 
    ...
    </div><!-- <- End #page --><?php // Close row-fluid and span9.
    }
