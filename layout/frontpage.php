...
<?php echo $coursecontentheader; ?>
    ...
    <?php if ($layout !== 'content-only') {
          if ($layout === 'pre-and-post') { ?>
            ...
            <form id="coursesearch3" action="http://localhost:8888/learningspace/course/search.php" method="get"><fieldset class="coursesearchbox invisiblefieldset"><input type="text" id="coursesearchbox" size="30" name="search" value="" placeholder="Search courses"><input type="submit" value="Go"></fieldset></form>
    <?php } else if ($layout === 'side-pre-only') { ?>
